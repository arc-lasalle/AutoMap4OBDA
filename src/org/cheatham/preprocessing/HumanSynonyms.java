...
public class HumanSynonyms extends DefaultHandler {
	...
	private static File humanSynonymFile = new File("human_synonyms");
	...
	public void init(String theURI) {
		...
		if (cache == null) {
			...
			if (humanSynonymFile.exists()) {
				try {
					ObjectInputStream ois = new ObjectInputStream(new FileInputStream(humanSynonymFile));
	...
	public HashSet<String> getSynonyms(URI entity) {
		...
		if (!initialized) {
			this.init("data/anatomy/human.owl");
		}
...
//	}
	...
	public static void close() {
		try {
			ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(humanSynonymFile));
	...
	public static void main(String[] args) throws URISyntaxException {
		...
		HumanSynonyms p = new HumanSynonyms();
